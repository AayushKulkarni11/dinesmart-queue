  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-32 pb-20">
        <section className="bg-gradient-warm py-12 mb-12">
        ...
        <div className="container">
          {/* Category tabs */}
          <div className="flex flex-wrap justify-center gap-2 mb-10 sticky top-24 z-30 py-3 -mx-2 px-2 bg-background/80 backdrop-blur-md rounded-full">
            {categories.map((c) => (
              <button
                key={c}
                onClick={() => setActive(c)}
          ...
          <div className="mb-8 flex items-center gap-3">
            ...
            <h2 className="font-display text-2xl font-semibold text-primary">{active}</h2>
            <span className="text-sm text-muted-foreground">({filtered.length} dishes)</span>
              ...
              >
                ...
                <div className="p-5">
                  <div className="flex items-start justify-between gap-3 mb-2">
                    <h3 className="font-display text-xl font-semibold text-primary leading-snug">{dish.name}</h3>
                  ...
                  <Button variant="outline" size="sm" className="w-full" onClick={() => handleAdd(dish)}>
