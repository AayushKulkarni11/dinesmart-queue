      ...
      <div className="flex items-center justify-center p-6 sm:p-12 bg-gradient-warm min-h-screen">
        <div className="w-full max-w-md animate-fade-in">
          ...
          <div className="bg-card rounded-3xl shadow-elegant border border-border/50 p-8">
            ...
            <p className="text-muted-foreground mb-6 text-sm">Welcome back. Choose your role to continue.</p>
            ...
            <form onSubmit={onSubmit} className="space-y-4" noValidate>
              <div>
                <Label htmlFor="email" className="mb-1.5 flex items-center gap-2 text-sm">
                ...
                <Input
                  ...
                  className={cn("h-11 bg-background", errors.email && "border-destructive focus-visible:ring-destructive")}
                  aria-invalid={!!errors.email}
                />
                {errors.email && <p className="text-xs text-destructive mt-1">{errors.email}</p>}
              </div>
              <div>
                <Label htmlFor="password" className="mb-1.5 flex items-center gap-2 text-sm">
                ...
                <Input
                  ...
                  placeholder="••••••••"
                  className={cn("h-11 bg-background", errors.password && "border-destructive focus-visible:ring-destructive")}
